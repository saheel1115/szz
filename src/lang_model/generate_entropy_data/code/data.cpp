...
{ 
	...
	while (i < argc)
	{
        ...
        else if (strcmp(argv[i], "-CACHE_BACKOFF_WEIGHT") == 0)
        {
            CACHE_BACKOFF_WEIGHT = atoi(argv[i+1]);
            i += 2;
        }
